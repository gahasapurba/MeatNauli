...
@section('title', 'QnA (List Pertanyaan)')
                ...
                <div class="d-inline-block dropdown">
                    <form method="GET" action="{{ route('questionsearch') }}">
                        ...
                        <div class="input-group">
                            <input type="text" name="search" id="search" class="form-control form-control-sm" placeholder="Cari Pertanyaan" value="{{ old('search') }}">
