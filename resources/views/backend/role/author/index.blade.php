    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div>Author
                    <div class="page-title-subheading">Berikut Daftar Author Yang Terdaftar di Website MeatNauli
                    </div>
                </div>
            </div>
                ...
                <div class="d-inline-block dropdown">
                    <form method="GET" action="{{ route('authorsearch') }}">
                        ...
                        <div class="input-group">
                            <input type="text" name="search" id="search" class="form-control form-control-sm" placeholder="Cari Author" value="{{ old('search') }}">
                ...
                <div class="table-responsive">
                    <table class="mb-0 table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="text-center"><b>{{ $author + $authors->firstitem() }}</b></td>
                                ...
                                <td class="text-center">
                                    <form method="POST" action="{{ route('author.edits', $result->id) }}">
                                        @csrf
                                        @method('get')
                                        <button type="submit" class="mr-2 btn-icon btn-icon-only btn btn-outline-warning">Jadikan Seller</button>
                                    </form>
                                    &nbsp;
